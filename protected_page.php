...
$defaultAvatar = 'uploads/default-avatar.png'; // Путь к изображению-заглушке
$userAvatar = !empty($user['avatar']) ? 'uploads/' . $user['avatar'] : $defaultAvatar; // Проверка на наличие аватара
?>
...
<body>
    <div id="search-container">
         <a href="edit_profile.php" class="avatar-link"></a>
    </div>
<div id="search-results"></div>
   ...
   <header>
    ...
    <nav>
        <ul>
            <li><a href="events2.php" class="link">Афиша</a></li>
            <li><a href="not.html" class="link">Уведомления</a></li>
            <li><a href="directory34.html" class="link">Справочник</a></li>
    ...
    <!-- Добавляем аватар-ссылку в правый угол -->
</header>
    <div class="carousel">
        <div class="slides">
            <div class="slide">
...
#video {
        ...
        .avatar-link {
             position: absolute; /* Абсолютное позиционирование для аватара */
    right: 20px;
            display: inline-block;
            border-radius: 50%;
            width: 50px;

...
<style>
    ...
    width: 100%;
    height: 115%;
    object-fit: cover; /* Видео занимает весь экран, сохраняя пропорции */
    z-index: -1; /* Видео будет позади всех остальных элементов */
}
...
header {
    background: rgba(74, 145, 226, 0.219); /* Полупрозрачный фон */
    color: #fff;
    padding: 20px;
    text-align: center;

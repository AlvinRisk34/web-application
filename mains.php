...
<body>
    <div id="search-container">
        <img src="https://i.ibb.co.com/g6xM6NZ/logo.png" alt="Логотип сайта" id="search-logo">
        <input type="text" id="search-bar" placeholder="Поиск на сайте..." oninput="searchWords()">
    </div>
<div id="search-results"></div>
    ...
    <header>
        ...
        <h1>Мой Город - Петропавловск</h1>
        <nav>
            <ul>
                <li><a href="events.php" class="link">Афиша</a></li>
                <li><a href="notifications" class="link">Уведомления</a></li>
                <li><a href="directory.html" class="link">Справочник</a></li>
                <li><a href="feedback.php" class="link">Обсуждения</a></li>
                <li>
    ...
    <button onclick="toggleAuthMenu()">Вход / Регистрация</button>
    <div id="auth-menu" style="display: none;">
        <input type="text" id="username" placeholder="Логин" required />
        <input type="email" id="email" placeholder="Email" required /> <!-- Поле для email -->
...
.slide-caption p {
    ...
    <section class="article" id="events">
        ...
        <textarea id="event-description" placeholder="Описание события"></textarea>
    ...
    <header>
        <h1>Уведомления о работах</h1>
    </header>

    <section class="article" id="notifications">
        <h2>Уведомления о городских работах</h2>
        <div id="notification-list"></div>
        <button onclick="loadNotifications()">Загрузить уведомления</button>
    </section>
  ...
  <footer class ="footer" >
        <div class="footer-container">
            <img src="https://i.ibb.co.com/g6xM6NZ/logo.png" alt="Логотип MyCity" id="footer-logo" />
            <h3 id="petro"> PETRO</h3>
            <div class="footer-info">
                <p>Телефон: +7 (123) 456-78-90</p>
                <p>Email: info@moigorod.ru</p>
                <div class="weather">
                    <p>Погода: <span id="temperature">--</span>°C</p>
                </div>
...
header {
    ...
    background: linear-gradient(135deg, #210a85, #3288ba); /* Градиентный фон */
}
